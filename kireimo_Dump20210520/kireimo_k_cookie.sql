...
--
-- Table structure for table `k_cookie`
--

DROP TABLE IF EXISTS `k_cookie`;
...
CREATE TABLE `k_cookie` (
  ...
  KEY `del_flg` (`del_flg`)
) ENGINE=InnoDB AUTO_INCREMENT=1128391 DEFAULT CHARSET=utf8;
...
-- Dump completed on 2021-05-20 12:15:43
