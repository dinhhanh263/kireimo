...
--
-- Table structure for table `loan_info3`
--

DROP TABLE IF EXISTS `loan_info3`;
...
CREATE TABLE `loan_info3` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4001 DEFAULT CHARSET=utf8 COMMENT='ライフティ申込';
...
-- Dump completed on 2021-05-20 12:11:32
