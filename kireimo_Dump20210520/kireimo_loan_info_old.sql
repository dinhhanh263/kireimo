...
--
-- Table structure for table `loan_info_old`
--

DROP TABLE IF EXISTS `loan_info_old`;
...
CREATE TABLE `loan_info_old` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=17257 DEFAULT CHARSET=utf8 COMMENT='サクシードローン(旧)';
...
-- Dump completed on 2021-05-20 12:11:42
