...
--
-- Table structure for table `pay_monthly`
--

DROP TABLE IF EXISTS `pay_monthly`;
...
CREATE TABLE `pay_monthly` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1881317 DEFAULT CHARSET=utf8;
...
-- Dump completed on 2021-05-20 12:14:42
