...
CREATE TABLE `reservation` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `double_booking` (`shop_id`,`room_id`,`hope_date`,`hope_time`,`reg_date`),
...
) ENGINE=InnoDB AUTO_INCREMENT=8534785 DEFAULT CHARSET=utf8;
...
-- Dump completed on 2021-05-20 12:13:50
