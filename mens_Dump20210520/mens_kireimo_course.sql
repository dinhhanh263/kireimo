...
CREATE TABLE `course` (
  ...
  `part_length` int(4) NOT NULL COMMENT '施術時間(部位ごと)',
  `price` int(11) DEFAULT NULL,
  `times` tinyint(4) NOT NULL COMMENT '回数',
  `period` smallint(6) DEFAULT NULL COMMENT '返金保証期間(日)',
  `memo` text NOT NULL,
  `one_flg` tinyint(4) NOT NULL COMMENT '1回コースフラグ',
  `zero_flg` tinyint(4) DEFAULT '0' COMMENT 'PREMIUMフラグ 1.あり',
...
-- Dump completed on 2021-05-20 12:27:27
