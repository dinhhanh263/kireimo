...
CREATE TABLE `sheet` (
  ...
  `birthday` date DEFAULT NULL COMMENT '誕生日(yyyy-mm-dd)',
  ...
  `parent_name` varchar(63) NOT NULL COMMENT '保護者の名前',
  ...
  `suggested_part` varchar(100) NOT NULL COMMENT '希望部位',
  `face_area` varchar(30) NOT NULL COMMENT '希望パーツ(顔)',
  `upper_area` varchar(30) NOT NULL COMMENT '希望パーツ(上半身)',
  `lower_area` varchar(30) NOT NULL COMMENT '希望パーツ(下半身)',
  `vio_area` varchar(30) NOT NULL COMMENT '希望パーツ(VIO)',
  `whole_area` varchar(30) NOT NULL COMMENT '希望パーツ(全身)',
  `self_face` varchar(63) NOT NULL COMMENT '上半身の自己処理方法',
  `self_face_other` varchar(255) NOT NULL COMMENT '上半身の自己処理方法(その他)',
  `self_body` varchar(63) NOT NULL COMMENT '下半身の自己処理方法',
  `self_body_other` varchar(255) NOT NULL COMMENT '下半身の自己処理方法(その他)',
...
-- Dump completed on 2021-05-20 12:27:42
