...
CREATE TABLE `shop` (
  ...
  `counseling_rooms` varchar(4) NOT NULL,
  `current_c_rooms` varchar(4) NOT NULL COMMENT '現在カウンセリングルーム数',
  `medical_rooms` varchar(4) NOT NULL,
  `current_m_rooms` varchar(4) NOT NULL COMMENT '現在施術ルーム数',
  `pack_rooms` varchar(4) NOT NULL,
  `vip_rooms` varchar(4) NOT NULL,
...
-- Dump completed on 2021-05-20 12:28:57
